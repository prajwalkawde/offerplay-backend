    ...
    await Promise.all([
        prisma.contest.upsert({
            ...
            create: {
                ...
                type: client_1.ContestType.MEGA,
                entryFee: 100,
                maxPlayers: 1000,
                minPlayers: 10,
                ...
                gameEndTime: gameEnd,
                prizeType: client_1.PrizeType.COINS,
                totalPrizePool: 50000,
                prizeDistribution: { '1': 20000, '2': 10000, '3': 5000, '4': 3000, '5': 2000 },
                status: client_1.ContestStatus.REGISTRATION_OPEN,
            },
        }),
        prisma.contest.upsert({
            ...
            create: {
                ...
                type: client_1.ContestType.ONE_V_ONE,
                entryFee: 50,
                maxPlayers: 2,
                minPlayers: 2,
                regStartTime: regStart,
    ...
    const questionTemplates = [
        {
            ...
            optionsFn: (m) => [m.team1, m.team2],
            points: 50,
        },
        {
            question: 'Who will win the match?',
            optionsFn: (m) => [m.team1, m.team2, 'No Result'],
            points: 100,
        },
        {
