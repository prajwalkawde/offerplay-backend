...
exports.generateQuestionsWithContext = generateQuestionsWithContext;
...
[
  {
    ...
    "reason": "brief reason"
        ...
        return questions.map(q => {
            ...
            if (!v || v.confidence < 0.85)
                return q; // keep original, flag for review
...
async function generateQuestionsWithContext(matchData) {
    try {
...
[
  {
    ...
    "isPreMatch": true
        ...
        logger_1.logger.error('generateQuestionsWithContext error:', err);
